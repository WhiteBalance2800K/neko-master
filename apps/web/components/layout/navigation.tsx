...
export function Navigation({
  ...
  return (
    <>
      ...
      <aside className="app-surface hidden lg:flex flex-col w-64 h-screen sticky top-0 border-r border-transparent backdrop-blur-md">
        {/* Logo */}
        <div className="flex items-start gap-3 p-6 border-b border-transparent">
        ...
        {/* Bottom Actions */}
        <div className="p-4 border-t border-transparent space-y-1">
          <button
      ...
      <nav className="app-surface lg:hidden fixed bottom-0 left-0 right-0 z-50 border-t border-transparent backdrop-blur-md">
